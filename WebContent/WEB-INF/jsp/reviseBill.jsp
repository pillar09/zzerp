...
<body>
    ...
    <div class="main" >
    	...
    	<form action="../bill/reviseBill.go" method="post">
        ...
        <div class="formBox"> 
        	<div class="content" >
              ...
              <%-- <tr>
				...
				<th>省/州：</th>
					...
					<th>手机：</th>
                    <td><input  name='phone_num' value='${bill.phone_num}' type="text" ></input></td>
                 </tr>
            ...
            <tr>
                ...
                <tr>
                <th>发货方式：</th>
                <td><input type="text" name='deliver_with' value="${bill.deliver_with}"></input></td>
            </tr>
             <tr>
                <th>快递代理：</th>
                  <td><input type="text"  name='logistics'  value="${bill.logistics}"></input></td>
		     </tr>
              <tr>
                <th>物流单号：</th>
                  <td><input type="text"  name='waybill_num' value="${bill.waybill_num}"></input></td>
              </tr>
              <tr>
                 <th>运费(￥)：</th>
                 <td><input type="text"  name='freight' onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" value="${bill.freight}" ></input></td>
			  </tr>
            </table>
            <div class="clear"></div>
        	</div>
          ...
          <h3><span class="fl_l">包裹</span></h3> 
            <table id="packsTable"> 
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" style='width:40px;' name='pkList[${pk.key}].length' value='${pk.value.length}' onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" maxlength="9" class="package"/>
                    <input type="text" style='width:40px;' name='pkList[${pk.key}].width' value='${pk.value.width}' onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" maxlength="9" class="package"/>
                    <input type="text" style='width:40px;' name='pkList[${pk.key}].height' value='${pk.value.height}' onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" maxlength="9" class="package"/>
                    </td>
                    <td><input type="text" style='width:40px;' name='pkList[${pk.key}].volume_rate' value='${pk.value.volume_rate}' onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="9" class="package"/></td>
                    <td>${pk.value.volume_weight}</td>
                    <td><input type="text" style='width:40px;' name='pkList[${pk.key}].weight' value='${pk.value.weight}' onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" maxlength="9" class="package"/></td>
                    ...
                    <td><input type="text" name='pkList[${pk.key}].waybill_num' value='${pk.value.waybill_num}' class="waybill_num"/></td>
                     -->
                    <td><input type="text" style='width:40px;' name='pkList[${pk.key}].freight' value='${pk.value.freight}' onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" maxlength="5" class="freight"/></td>
